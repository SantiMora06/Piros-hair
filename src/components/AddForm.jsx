...
const DynamicFormWithHookForm = () => {
    ...
    const onSubmit = async (data) => {
        console.log("Form data to submit:", data); // Debugging log
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log("Successfully created item:", result); // Success log
                // Reset form after successful submission
                reset();
                setSelectedOption("");
                setFormFields([]);
            } else {
                console.error("Failed to create item:", response.statusText); // Error log
            }
        } catch (error) {
    ...
    return (
        <div className={classes.form}>
            <button onClick={toggleDropdown}>
                {isDropdownVisible ? "Hide New Route" : "Show New Route"}
            </button>
